...
!!! exercise
    Crie um fork do repositório original

!!! exercise "Alterando o nome do Fork"
...
!!! exercise
    Adicionar todos os membros como `owner` do repositório.
...
2. Instala todo a infra necessária do projeto (no nosso caso: python, ...)
...
!!! exercise 
    Editar localmente o arquivo `GRUPO.yml`, apenas no `NOME-DO-GRUPO`
